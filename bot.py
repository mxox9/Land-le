...
# Start Command with channel join check - UPDATED
...
def start_command(message):
    try:
        ...
        # Check if user is member of channel - UPDATED FORCE JOIN
...
We provide the best SMM services with 24/7 support!
            ...
            bot.send_photo(
                ...
                photo=FORCE_JOIN_IMAGE,  # Updated image
                caption=caption,
...
# Track Order Feature - UPDATED: REMOVED KEYBOARD ROW
...
🆔 You can find Order ID in your orders history
        ...
        # Ask for order ID without keyboard
        msg = bot.send_message(
            chat_id=call.message.chat.id,
            text="🔍 " + style_text("Please enter your Order ID:"),
            reply_markup=InlineKeyboardMarkup().add(
                InlineKeyboardButton("🔙 " + style_text("Cancel"), callback_data="land")
            )
        )
