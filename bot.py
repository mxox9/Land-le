...
# create bot inside try/except to provide clearer error messages for invalid tokens
try:
...
SERVICES = {
    "Iɴsᴛᴀɢʀᴀᴍ": [
        ...
        {
            "id": "4910",  # Replace with real SMM panel service ID
            "category": "Iɴsᴛᴀɢʀᴀᴍ",
            "name": "👁 Iɴsᴛᴀ Vɪᴇᴡs",
...
if __name__ == "__main__":
    ...
    # If it's an auth error, provide a helpful hint
    import telebot
    try:
        from telebot import apihelper
        if 'ApiTelegramException' in str(type(e)) or '401' in str(e):
            print("It looks like your BOT_TOKEN may be invalid or expired (HTTP 401).")
            print("Please check BOT_TOKEN in environment variables and restart.")
    except Exception:
        pass
    raise
