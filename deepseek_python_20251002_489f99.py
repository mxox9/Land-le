...
def main_menu_keyboard():
    ...
    if ADMIN_IDS:
        markup.add(InlineKeyboardButton("👑 Aᴅᴍɪɴ", callback_data="admin_panel"))
...
def show_categories(user_id, message_id):
    try:
        if not is_bot_accepting_orders():
            bot.answer_callback_query(message_id, "❌ Bᴏᴛ ɪs ᴄᴜʀʀᴇɴᴛʟʏ ɴᴏᴛ ᴀᴄᴄᴇᴘᴛɪɴɢ ᴏʀᴅᴇʀs.", show_alert=True)
            return
...
Cʜᴏᴏsᴇ ᴀ ᴄᴀᴛᴇɢᴏʀʏ ᴛᴏ ᴠɪᴇᴡ ᴀᴠᴀɪʟᴀʙʟᴇ sᴇʀᴠɪᴄᴇs:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴄᴀᴛᴇɢᴏʀɪᴇs.", show_alert=True)

def show_services(user_id, message_id, category):
    try:
        if category not in SERVICES:
            bot.answer_callback_query(message_id, "❌ Cᴀᴛᴇɢᴏʀʢ ɴᴏᴛ ғᴏᴜɴᴅ.", show_alert=True)
            return
...
Sᴇʟᴇᴄᴛ ᴀ sᴇʀᴠɪᴄᴇ ᴛᴏ ᴏʀᴅᴇʀ:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ sᴇʀᴠɪᴄᴇs.", show_alert=True)
...
Pʟᴇᴀsᴇ sᴇɴᴅ ᴛʜᴇ ʟɪɴᴋ ғᴏʀ ʏᴏᴜʀ ᴏʀᴅᴇʀ:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sᴛᴀʀᴛɪɴɢ ᴏʀᴅᴇʀ.", show_alert=True)
...
🛒 Pʟᴀᴄᴇ ʏᴏᴜʀ ғɪʀsᴛ ᴏʀᴅᴇʀ ɴᴏᴡ!
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴏʀᴅᴇʀs.", show_alert=True)
...
💰 Rᴇғᴇʀʀᴀʟ Cᴏᴍᴍɪssɪᴏɴ: 10%
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ʀᴇғᴇʀʀᴀʟ ɪɴғᴏ.", show_alert=True)
...
📦 Tᴏᴛᴀʟ Oʀᴅᴇʀs: {len(user_orders)}
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴀᴄᴄᴏᴜɴᴛ ɪɴғᴏ.", show_alert=True)
...
🛒 Yᴏᴜʀ Sᴘᴇɴᴅɪɴɢ: ₹{user.get('total_spent', 0):.2f}
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ sᴛᴀᴛs.", show_alert=True)
...
• Gᴇɴᴇʀᴀʟ ǫᴜᴇsᴛɪᴏɴs
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ sᴜᴘᴘᴏʀᴛ.", show_alert=True)
...
Sᴇʟᴇᴄᴛ ᴀɴ ᴏᴘᴛɪᴏɴ ʙᴇʟᴏᴡ:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴀᴅᴍɪɴ ᴘᴀɴᴇʟ.", show_alert=True)
...
Sᴇʟᴇᴄᴛ ᴀɴ ᴏᴘᴛɪᴏɴ ᴛᴏ ᴍᴀɴᴀɢᴇ ᴜsᴇʀ ʙᴀʟᴀɴᴄᴇs:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴀᴅᴍɪɴ ʙᴀʟᴀɴᴄᴇ ᴍᴇɴᴜ.", show_alert=True)
...
Sᴇʟᴇᴄᴛ ᴀɴ ᴏᴘᴛɪᴏɴ ᴛᴏ ᴍᴀɴᴀɢᴇ ᴜsᴇʀs:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴀᴅᴍɪɴ ᴜsᴇʀs ᴍᴇɴᴜ.", show_alert=True)
...
Sᴇʟᴇᴄᴛ ᴀɴ ᴏᴘᴛɪᴏɴ ᴛᴏ ᴍᴀɴᴀɢᴇ ʙᴏᴛ sᴇᴛᴛɪɴɢs:
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴀᴅᴍɪɴ sᴇᴛᴛɪɴɢs ᴍᴇɴᴜ.", show_alert=True)
...
🟢 Bᴏᴛ Sᴛᴀᴛᴜs: {'ON' if is_bot_accepting_orders() else 'OFF'}
        ...
        bot.answer_callback_query(message_id, "❌ Eʀʀᴏʀ sʜᴏᴡɪɴɢ ᴀᴅᴍɪɴ sᴛᴀᴛs.", show_alert=True)
