...
def callback_handler(call):
    try:
        ...
        # Admin callbacks - FIXED BACK BUTTONS
        ...
        # FIXED: Handle admin back buttons properly
        elif call.data in ["admin_balance_back", "admin_prices_back", "admin_service_ids_back", 
